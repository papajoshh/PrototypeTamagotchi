...
export class Sleep {
    constructor() {
        ...
        this._sleepHour = 22; // 22:00 (10 PM)
        this._wakeUpHour = 7; // 7:00 (7 AM)
        this._lightsOn = true;
        // Despertar temporal en modo automático
        this._temporaryWakeUp = false;
        this._temporaryWakeUpTime = 0;
        this.TEMPORARY_WAKE_DURATION = 5 * 60 * 1000; // 5 minutos en milisegundos
    }
    // Getters
    get isSleeping() {
    ...
    static createAwakeWithAutomaticMode() {
    ...
    static createAwakeWithManualMode() {
        const sleep = new Sleep();
        sleep._isSleeping = false;
    ...
    setSchedule(sleepHour, wakeUpHour) {
