...
export class Poop {
  private hasPooped: boolean = false;
  private timeUntilPoop: number = 0;
  private timeSincePoop: number = 0;
  ...
  scheduleAfterFeeding(stage: LifeStage) {
  ...
  hasPoopedNow(): boolean {
    return this.hasPooped;
  }

  shouldTriggerIllness(): boolean {
